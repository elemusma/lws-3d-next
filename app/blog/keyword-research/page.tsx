...
export const metadata: Metadata = {
  title:
    "Keyword Research Strategies for Expert Witness Visibility - Latino Web Studio",
  description:
  ...
  openGraph: {
    title:
      "Keyword Research Strategies for Expert Witness Visibility - Latino Web Studio",
    description:
      "Latino Web Studio explains keyword research and technical SEO to help expert witnesses improve visibility among attorneys.",
    url: `https://latinowebstudio.com/blog/keyword-research`,
    type: "article",
    images: [
      {
        url: `https://latinowebstudio.com/images/blog/Keyword-Research.png`,
        width: 1200,
        height: 630,
  ...
  alternates: {
    canonical: "https://latinowebstudio.com/blog/keyword-research",
  },
};
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            wordCount: 2000,
            image:
              "https://latinowebstudio.com/images/blog/Keyword-Research.png",
            author: {
              "@type": "Person",
              name: "Tadeo Martinez",
            ...
            mainEntityOfPage: {
              "@type": "WebPage",
              "@id": "https://latinowebstudio.com/blog/keyword-research",
            },
      ...
      >
        <div className="lg:w-3/4 w-full lg:pr-8 px-4">
          ...
          <p className="text-base text-gray-600 mb-4">
            ...
            and user intent behind search terms. Latino Web Studio uses such
          ...
          <p className="text-base text-gray-600 mb-4">
            ...
            Latino Web Studio integrates keyword research within site
          ...
          <p className="text-base text-gray-600 mb-4">
            ...
            attorneys search. Latino Web Studio specializes in combining
