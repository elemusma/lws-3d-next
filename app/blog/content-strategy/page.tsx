...
export const metadata: Metadata = {
  title:
    "Content Strategy for Expert Witnesses: Enhancing Visibility and Credibility Online - Latino Web Studio",
  description:
  ...
  openGraph: {
    ...
    description:
      "Content strategy for expert witnesses refers to the structured approach of planning, creating, and managing digital content with the goal of improving online visibility and establishing professional credibility.",
    url: "https://latinowebstudio.com/blog/content-strategy",
    type: "article",
    images: [
      {
        url: "https://latinowebstudio.com/blog/content-strategy.jpg",
        width: 1200,
        height: 630,
        alt: "Content Strategy for Expert Witnesses Guide - Latino Web Studio",
      },
    ],
  },
  alternates: {
    canonical: "https://latinowebstudio.com/blog/content-strategy",
  },
  keywords: [
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntityOfPage: {
              "@type": "WebPage",
              "@id":
                "https://latinowebstudio.com/blog/content-strategy-expert-witnesses",
            },
            headline:
            ...
            image:
              "https://latinowebstudio.com/blog/content-strategy-expert-witnesses.jpg",
            author: {
              "@type": "Organization",
      ...
      >
        <div className="lg:w-3/4 w-full lg:pr-8 px-4">
          ...
          <p className="mb-4">
            ...
            <Link href="https://latinowebstudio.com/">Latino Web Studio</Link>,
          ...
          <p className="mb-4">
            ...
            . Latino Web Studio often assists expert witnesses in this
          ...
          <p className="mb-4">
            ...
            <Link href="https://latinowebstudio.com/blog/web-traffic">
              website traffic
            </Link>{" "}
          ...
          <p className="mb-4">
            ...
            Partnering with digital agencies like Latino Web Studio ensures that
            technical SEO and{" "}
          ...
          <p className="mb-4">
            ...
            specialists like Latino Web Studio to implement SEO and UX best
            practices.
          </p>
