...
export const metadata: Metadata = {
  ...
  // ✅ Add this block:
  alternates: {
    canonical: "https://latinowebstudio.com/blog/more-cases", // Replace with the actual canonical URL
  },
};
      ...
      >
        <div className="lg:w-3/4 w-full lg:pr-8 px-4">
          ...
          <p className="text-base text-gray-700 mb-4">
            ...
            <Link href="https://latinowebstudio.com/blog/deposition-readiness-checklist">
          ...
          <p className="text-base text-gray-700 mb-6">
            ...
            in your field, we can help. Contact Latino Web Studio to discover
