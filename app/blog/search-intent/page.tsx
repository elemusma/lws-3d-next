...
export const metadata: Metadata = {
  ...
  // ✅ Add this block:
  alternates: {
    canonical: "https://latinowebstudio.com/blog/search-intent", // Replace with the actual canonical URL
  },
};
          ...
          <div className="lg:w-3/4 w-full lg:pr-8 px-4">
            ...
            <ul>
              <li>
                ...
                <a
                  href="https://discoveryengineering.net/blog/uber-lyft-sexual-assault-cases/"
                  target="_blank"
                >
