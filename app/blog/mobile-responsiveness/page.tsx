...
export const metadata: Metadata = {
  ...
  // ✅ Add this block:
  alternates: {
    canonical: "https://latinowebstudio.com/blog/mobile-responsiveness", // Replace with the actual canonical URL
  },
};
      ...
      >
        <div className="lg:w-3/4 w-full lg:pr-8 px-4">
          ...
          <p className="text-base leading-relaxed text-gray-600 mb-4">
            ...
            <Link href="https://latinowebstudio.com/blog/lawyers-experts-websites">
              website
            </Link>{" "}
          ...
          <p className="text-base leading-relaxed text-gray-600 mb-4">
            Latino Web Studio specializes in responsive design tailored to the
