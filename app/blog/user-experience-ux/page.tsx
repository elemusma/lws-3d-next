...
export const metadata: Metadata = {
  ...
  // ✅ Add this block:
  alternates: {
    canonical: "https://latinowebstudio.com/blog/user-experience-ux", // Replace with the actual canonical URL
  },
};
      ...
      >
        <div className="lg:w-3/4 w-full lg:pr-8 px-4">
          <article>
            ...
            <p className="text-base text-gray-700 mb-4">
              Latino Web Studio works specifically with expert witnesses to
            ...
            <p className="text-base text-gray-700 mb-4">
              Latino Web Studio helps expert witnesses strengthen their online
            ...
            <p className="text-base text-gray-700 mb-8">
              ...
              attorneys? Contact Latino Web Studio for a free UX evaluation and
