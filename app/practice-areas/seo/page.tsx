...
export default function PracticeAreasSEO() {
  ...
  dangerouslySetInnerHTML={{
    __html: JSON.stringify({
      ...
      "description": "SEO services designed to help expert witnesses get found by attorneys. Includes technical SEO, ADA compliance, fast loading speeds, and content strategy.",
      "provider": {
        "@type": "Organization",
      ...
      "url": "https://latinowebstudio.com/practice-areas/seo",
      "image": "https://latinowebstudio.com/practice-areas/SEO-Expert-Witness-Traffic-Increase-Lawyers-Retainers-Assignments.jpg",
      "keywords": "SEO for expert witnesses, legal SEO, attorney visibility, expert witness marketing",
      "inLanguage": "en",
      "offers": {
        "@type": "Offer",
        "priceCurrency": "USD",
        "price": "1500",
        "description": "Monthly SEO Package for Expert Witnesses",
...
{/* 9747469734196890752 */}
      ...
      >
        ...
        <p className="">We don&apos;t just build websites—we build for speed and visibility. Every site is optimized to load fast, helping you rank higher in Google and keep attorneys engaged from the first click.</p>
        </div>
        <div className="w-full lg:w-1/3 px-4 mb-8 lg:mb-0 text-center">
        <Image 
        ...
        <p>We write your content, based on real legal searches and safe for deposition. Each page is designed to build your authority and help attorneys understand your expertise quickly.</p>
        </div>
        <div className="w-full lg:w-1/3 px-4 mb-8 lg:mb-0 text-center">
        <Image 
        ...
        {/* <h3 style={{margin:0}}>Personalized Strategy & Support</h3> */}
        <p>We don&apos;t just build websites—we build your visibility. You&apos;ll get a custom SEO and design strategy based on your specific field, court experience, and goals.</p>
        </div>
      ...
      >
        ...
        width={1000}
        height={1333} alt={"Technical SEO Foundation and User Experience That Converts"} 
        />
        </div>
        <div className="w-full lg:w-1/2 px-4 mb-8 lg:mb-0">
        <div
      style={{
        ...
        paddingLeft: "15px",
        borderImage: "linear-gradient(0deg,rgba(255, 200, 15, 1) 0%, rgba(31, 24, 74, 1) 25%, rgba(181, 83, 159, 1) 75%, rgba(3, 186, 175, 1) 100%)",
        borderImageSlice: 1,
      }}
    >
      <h3 style={{ marginBottom: "0px" }}>Technical SEO Foundation</h3>
      <p>
        We optimize site speed, structure, and schema markup to boost your visibility in search engines—making sure attorneys can find and trust your expertise.
      </p>
    </div>
        <div
      style={{
    ...
    >
      <h3 style={{ marginBottom: "0px" }}>User Experience That Converts</h3>
      <p>
        We design clean, fast-loading pages with clear messaging and navigation—so attorneys quickly understand your value and are encouraged to reach out.
      </p>
    </div>
      ...
      >
        ...
        width={1000}
        height={1333} alt={"ADA-Compliant Design and Mobile Speed That Converts"} 
        />
        </div>
        <div className="w-full lg:w-1/2 px-4 mb-8 lg:mb-0">
        <div
    ...
    >
      ...
      <p>
        We build every site to meet accessibility standards—so it&apos;s usable by all visitors, reduces legal risk, and sends the right signals to Google.
      </p>
    </div>
        <div
      style={{
    ...
    >
      ...
      <p>
        We optimize for mobile-first performance—ensuring your site loads fast on phones, ranks well in Google, and keeps busy attorneys from bouncing.
      </p>
    </div>
      ...
      >
        <div className="w-full text-center pb-8">
            <h2 className="mt-0">The SEO Foundation Every Expert Witness Website Should Have</h2>
            <p>Yes, you may be on all the directories, but are they really bringing cases or is it mostly solicitation calls?</p>
        </div>
