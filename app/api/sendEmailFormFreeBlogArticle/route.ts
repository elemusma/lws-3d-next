...
<p><strong>Directory Profile:</strong> ${directory_profile}</p>
<p><strong>LinkedIn Profile:</strong> ${linkedin_profile}</p>
<p><strong>Practice Name:</strong> ${practice_name}</p>
<p><strong>Additional Directories or Information:</strong> ${message}</p>
</td>
</tr>
</tbody>
</table>
